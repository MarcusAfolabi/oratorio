...
<head>
    ...
    <link rel="preload" href="{{ asset('assets/css/all.min.css') }}" as="style" crossorigin="anonymous"
...
<body>
            ...
            <div class="modal-dialog popup-box-dialog modal-dialog-centered">
                <div class="modal-content popup-box-content">
                    <div class="popup-card" style="width:100%">
                        ...
                        <form action="https://checkout.flutterwave.com/v3/hosted/pay" class="popup-form"
                            method="POST">
                            @csrf
                            <div class="row gy-3 mb-3">
                                <div class="col-lg-6">
                                    <label for="exampleFormControlInput5" class="form-label">Full name</label>
                                    <input type="text" class="form-control" name="customer[name]" id="fullname"
                                        placeholder="Your name" required>
                                </div>
                                <input type="hidden" name="public_key"
                                    value="FLWPUBK-fd46e84af0c86ba8904baef11a90ccc4-X" />
                                <input type="hidden" name="tx_ref" value="<?php echo date('H:i:s'); ?>" />
                                <input type="hidden" name="currency" value="NGN" />
                                <input type="hidden" name="redirect_url"
                                    value="https://oratoriogroup.org/#status" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control bg-black-50" name="options" id="options" required>
                                        <option
                                            title="These are musical Instruments to be used for rehearsals such as keyboard, gitar, drum-set"
                                            value="Musical Instruments">Musical Instruments </option>
                                        <option
                                            title="These are outreach to urban and rural area, spreading the word of God, providing medical aids, and welfare material"
                                            value="Evangelism Support">Community-work Support </option>
    ...
    <link rel="preload" href="{{ asset('assets/dist/jquery-3.6.0.min.js') }}" as="script"
        integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous">
    <script src="{{ asset('assets/dist/jquery-3.6.0.min.js') }}"
