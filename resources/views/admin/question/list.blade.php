...
@section('canonical', 'https://oratoriogroup.org/audition')
@section('content')
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-900"> {{ $test->id }}  </td>
                                        ...
                                        <td class="text-sm text-green-900 font-light px-6 py-4 whitespace-nowrap"> <a href="{{ route('audition.edit', $test) }}"> <span class="icon-feather-edit "></span></a></td>
                                        <td class="text-sm text-green-900 font-light px-6 py-4 whitespace-nowrap">
                                            <form action="{{ route('audition.destroy', $test) }}" method="POST">
                                                @csrf
                                                @method('delete')
...
<div id="modal-field" uk-modal>
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
            <h2 class="uk-modal-title"><i class="icon-material-outline-add"></i> Add new Test Question</h2>
        </div>
        <form method="POST" action="{{ route('audition.store') }}" >
            @csrf
            <div class="p-10 space-y-7">
                <div class="line">
                    <input class="line__input" id="title" name="question" type="text" onkeyup="this.setAttribute('value', this.value);" value="{{ old('title') }}" autocomplete="off">
                ...
                <div class="line">
                    <input class="line__input" id="correctAnswer" name="correct_answer" type="text" onkeyup="this.setAttribute('value', this.value);" value="{{ old('correct-answer') }}" autocomplete="off">
