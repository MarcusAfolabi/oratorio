...
@section('description', 'Medium of Empowering through professional skills and growing your networks with influencers and by mentors')
@section('keywords', 'media, freelancers, freelancing, upwork, skills, empowerment, ngo, professions, expert, empowering, growing, networks, influencers, mentors')
@section('canonical', 'https://oratoriogroup.org/media')
@section('content')
        ...
        <div class="flex justify-between items-center relative md:mb-4 mb-3">
            <div class="flex-1">
                <h5 class="text-1xl font-semibold">
                    <a uk-tooltip="Add" href="#modalMedia" uk-toggle><i class="icon-material-outline-add"></i> Media Types  </a>
                </h5>
            </div>
        </div>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="text-sm text-green-900 font-light px-6 py-4 whitespace-nowrap"> <a href="{{ route('media.edit', $media) }}"> <span class="icon-feather-edit "></span></a></td>
...
<div id="modalMedia" uk-modal>
    <div class="uk-modal-dialog">
        <button class="uk-modal-close-default m-3" type="button" uk-close></button>
        <div class="uk-modal-header">
            <h2 class="uk-modal-title"><i class="icon-material-outline-add"></i> Add new Media type</h2>
        </div>
        <form method="POST" action="{{ route('media.store') }}" >
            @csrf
            <div class="p-10 space-y-7">
                <div class="line">
                    <input class="line__input" id="type" name="type" type="text" onkeyup="this.setAttribute('value', this.value);" value="{{ old('type') }}" autocomplete="off">
