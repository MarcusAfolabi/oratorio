...
@section('title', 'Working industries')
    ...
    <div class="mcontainer">
        <div class="breadcrumb-area py-0">
            <div class="breadcrumb">
                <ul class="m-0">
                    <li>
                        <a href="{{ route('industry.index') }}">All industry</a>
                    </li>
                    <li class="active">
                        <a href="#">Add New industry </a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="max-w-2xl m-auto shadow-md rounded-md bg-white lg:mt-20">
            ...
            <div class="text-center border-b border-green-100 py-6">
                <h3 class="font-bold text-xl"> Edit - {{ $industry->name }} </h3>
            </div>
            <form method="POST" action="{{ route('industry.update', $industry) }}">
                @csrf
                @method('PUT')
                <div class="p-10 space-y-7">
                    <div class="line">
                        <input class="line__input" id="name" name="name" type="text" onkeyup="this.setAttribute('value', this.value);" value="{{ $industry->name }}" autocomplete="off">
