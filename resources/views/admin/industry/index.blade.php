...
@section('title', 'Working Industry')
@section('description', 'Working Industry through professional skills and growing your networks with influencers and by mentors')
@section('keywords', 'industry, working, skills, empowerment, ngo, professions, expert, empowering, growing, networks, influencers, mentors')
@section('canonical', 'https://oratoriogroup.org/industry')
@section('content')
        ...
        <div class="flex justify-between items-center relative md:mb-4 mb-3">
            <div class="flex-1">
                <h5 class="text-1xl font-semibold">
                    <a uk-tooltip="Add" href="#modalIndustry" uk-toggle><i class="icon-material-outline-add"></i> Working Industry  </a>
                </h5>
            </div>
        </div>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="text-sm text-green-900 font-light px-6 py-4 whitespace-nowrap"> <a href="{{ route('industry.edit', $industry) }}"> <span class="icon-feather-edit "></span></a></td>
...
<div id="modalIndustry" uk-modal>
    <div class="uk-modal-dialog">
        <button class="uk-modal-close-default m-3" type="button" uk-close></button>
        <div class="uk-modal-header">
            <h2 class="uk-modal-title"><i class="icon-material-outline-add"></i> Add new Industry</h2>
        </div>
