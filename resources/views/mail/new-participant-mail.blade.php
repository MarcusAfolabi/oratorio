...
<x-mail::button :url="'https://oratorio.test/ORATORIO_MUSIC_FOUNDATION_HANDBOOK.pdf'">
Download Handbook
</x-mail::button>
...
<x-mail::button :url="'https://oratorio.test/auditions/test?email=' . $participant->email">
Take Audition Test
</x-mail::button>
