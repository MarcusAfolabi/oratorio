                ...
                <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                    ...
                    <div uk-lightbox>
                        <div class="grid grid-cols-2 gap-2 px-5">
                            ...
                            <a href="{{ asset('storage/app/public/' . $image->path) }}" class="relative">
                                <img src="{{ asset('storage/app/public/' . $image->path) }}" alt="{{ $post->user->name }}" class="rounded-md w-full h-full">
                            </a>
                            @elseif (in_array($extension, ['mp4', 'ogg', 'webm']))
                            <video width="320" height="240" controls>
                                <source src="{{ asset('storage/app/public/' . $image->path) }}" type="video/{{ $extension }}">
                                Your browser does not support the video tag.
                            </video>
                            @elseif (in_array($extension, ['mp3', 'wav', 'ogg']))
                            <!-- <audio controls> -->
                            <audio class="js-player">
                                <source src="{{ asset('storage/app/public/' . $image->path) }}" type="audio/{{ $extension }}">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-red-50">
                            <a href="{{ route('post.show', $post) }}" class="w-12 h-12 flex-shrink-0 overflow-hidden rounded-full relative">
                                <img src="{{ asset('storage/app/public/' . $event->images[0]->path) }}" class="absolute w-full h-full inset-0 " alt="">
                            </a>
                            <div class="flex-1">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-red-50">
                            <a href="{{ route('post.show', $job) }}" class="w-12 h-12 flex-shrink-0 overflow-hidden rounded-full relative">
                                <img src="{{ asset('storage/app/public/' . $job->images[0]->path) }}" class="absolute w-full h-full inset-0 " alt="">
                            </a>
                            <div class="flex-1">
