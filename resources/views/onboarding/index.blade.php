...
@section('title', 'Membership Terms and Obligations | Oratorio Music Foundation')
    ...
    <div class="mcontainer">
        ...
        <div class="bg-white max-w-4xl mx-auto md:p-10 p-6 relative rounded-md shadow">
            ...
            <div class="md:space-y-6 space-y-4 text-gray-400 md:text-lg">
                ...
                <div class="md:leading-8 text-sm leading-7"> Updated May 09, 2023</div>
                <div class="font-semibold md:text-sm text-sm text-gray-700 mt-2"> Members Terms and Obligations </div>
                <div class="text-sm md:leading-8 leading-7"> On behalf of the Oratorio Music Foundation, I am delighted to extend our warmest
                    congratulations and a wholehearted welcome to you as a newly accepted member of our
                    esteemed musical family. We were truly impressed by your exceptional audition performance,
                    and it is with great pleasure that we offer you a place in our ensemble.
                    ...
                    <div class="text-sm md:leading-8 leading-7"> 1. Members must be available for fasting and prayer sessions called by the group's leadership.
                    ...
                    <div class="text-sm md:leading-8 leading-7"> 1. Members should give priority to the Oratorio Group's activities over other non-academic commitments.
                    </div>
                    ...
                    <hr>
                    <br>
                    <div class="text-sm md:leading-8 leading-7 text-black"> As you embark on this exciting journey with us, we look forward to witnessing your growth and contribution to our collective passion for creating beautiful and inspiring music.
                        <br>
                        We are planning an orientation and welcome event for all new members, during which you will
                        have the chance to meet your fellow musicians, our conductors, and the administrative team.
                        <br>
                        This event will be a great opportunity for you to get acquainted with our organization's mission,
                        values, and upcoming projects.


                    </div>
                    <div class="text-sm md:leading-8 leading-7 text-black"> Once again, congratulations on becoming a member of the Oratorio Music Foundation. We are
                        thrilled to have you on board and are confident that your presence will enrich our musical
                        community.</div>

                    <form action="{{ route('register') }}" method="POST" class="p-7 space-y-5">
                        @csrf
                        <div class="grid lg:grid-cols-2 gap-5">
                            <input type="text" id="firstname" name="name" placeholder="First Name" class="with-border">
                            <input type="text" id="lastname" name="last_name" placeholder="Surname" class="with-border">
                            ...
                            <select name="gender" id="gender" class="px-3 py-3 with-border">
                                <option selected hidden>Select gender</option>
                                <option value="Male">Male</option>
                                <option value="Female">Female</option>
                            </select>
                            <select name="community_id" id="community_id" class="px-3 py-3 with-border">
                                <option selected hidden>Select Campus</option>
                                @foreach($communities as $community)
                                <option value="{{ $community->id }}">{{ $community->name }}</option>
                                @endforeach
                            </select>
                            <input type="tel" name="phone" id="phone" placeholder="Enter phone number" class="px-5 py-3 with-border">
                        </div>
                        <p class="text-xs text-gray-400 pt-3">By clicking Sign Up, you agree to our
                            <a href="" class="text-green-500 hover:text-green-500">Terms</a>, and
                            <a href="" class="text-green-500 hover:text-green-500">Obligations</a>  stated above
                        </p>
                        <div class="flex">
