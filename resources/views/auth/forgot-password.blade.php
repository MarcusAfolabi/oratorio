...
@section('title', 'Resend Password link')
@section('main')
<div class="bg-white">
    <div class="container">
            ...
            <div class="col-md-4 mx-auto">
                <div class="osahan-login py-4">
                    <div class="text-center mb-4">
                        ...
                        <h5 class="font-weight-bold mt-3">Forgot your password?</h5>
                        <p class="text-muted">Just let us know your email address and we will email you a password reset link </p>
                    </div>
                    @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <button class="btn btn-danger btn-block text-uppercase" type="submit"> Find account
                        </button>
